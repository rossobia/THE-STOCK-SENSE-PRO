...
Projenin %100 kesintisiz erişebilmesini garanti altına almak amacıyla, DNS filtrelerine takılmayan **GitHub Pages** (`.github.io`) altyapısına geçiş yapılmıştır. Cloudflare sunucusu ise yedek ortam olarak aktif tutulmaktadır.
